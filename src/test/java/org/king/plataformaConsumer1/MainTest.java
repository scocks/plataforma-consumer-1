...
class MainTest {
    ...
    void testGreet2() {
        ...
        assertEquals("Via plataforma: Greetings, plataforma-consumer-1!", result);    }
    @Test
    void testGreet3() {
        Library library = new Library();
        String result = library.greet3("plataforma-consumer-1");
        assertEquals("Via plataforma: Salutations, plataforma-consumer-1!", result);    }
    @Test
    void testGreet4() {
        Library library = new Library();
        String result = library.greet4("plataforma-consumer-1");
        assertEquals("Via plataforma: Hej, plataforma-consumer-1!", result);    }
    @Test
    void testGreet5() {
        Library library = new Library();
